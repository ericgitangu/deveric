...
The platform features 5 Rust microservices on AWS Lambda, a Next.js 16 frontend deployed on Vercel, native Android app with Jetpack Compose, and AI-powered features using Claude for product identification and healthcare summaries.
