...
**Live Demo:** [pawacloud-web.vercel.app](https://pawacloud-web.vercel.app) | **API Docs:** [Swagger](https://pawacloud-api-904401126919.africa-south1.run.app/docs) | **Status:** [Dashboard](https://pawacloud-web.vercel.app/status)

# Architecture

## System Overview

Split-deploy architecture with backend on GCP Cloud Run and frontend on Vercel, both targeting Africa regions for lowest latency:
...
```
User -> Next.js (Vercel) -> FastAPI (Cloud Run africa-south1)
