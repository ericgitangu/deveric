...
description: A modern, interactive resume web application featuring an AI-powered chatbot that answers questions about my professional background, built with Next.js 16, Claude AI, and deployed on Fly.io
...
A cutting-edge interactive resume that goes beyond the traditional PDF format. This application showcases my professional experience through dynamic visualizations, real-time data rendering, and an AI chatbot powered by Claude that can answer detailed questions about my background, skills, and experience.
...
- **AI**: Claude AI (Anthropic) with RAG architecture
...
### AI-Powered Chatbot
- **Claude Integration**: Powered by Claude Sonnet for intelligent, contextual responses
