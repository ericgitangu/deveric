...
description: Production-grade ride-sharing platform with real-time Google Maps integration, Places Autocomplete, live ETA via Distance Matrix API, Kenyan market-rate pricing, and a FastAPI + GCP Cloud Run backend. Full-stack Next.js 16 PWA deployed on Vercel / Fly.io.
date: "2026-04-01"
url: https://unirides.unicorns.run
...
Visit [unirides.unicorns.run](https://unirides.unicorns.run) to experience a production-grade ride-sharing app built from the ground up. Request rides between any two locations in Nairobi with real-time fare estimates, route visualization, and live driver tracking.
