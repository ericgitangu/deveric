...
date: "2026-03-05"
url: https://bsd-engine-web.vercel.app
...
**Live Demo:** [bsd-engine-web.vercel.app](https://bsd-engine-web.vercel.app)
...
- Vercel — Frontend deployment; GCP Cloud Run — API deployment
...
# API
cd crates/bsd-api && gcloud run deploy bsd-engine-api --region africa-south1 --source .
